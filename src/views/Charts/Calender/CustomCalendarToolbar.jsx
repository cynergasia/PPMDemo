  ...
  render() {
    return (<div>
      <div className="rbc-toolbar">
        <span><button className="btn btn-sm" onClick={() => this.changeNavidate('PREV')}> &#8592; </button></span> &nbsp;
        <span><button className="btn btn-sm" onClick={() => this.changeNavidate('NEXT')}> &#8594; </button></span>
